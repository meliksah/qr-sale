 ...
 * Express Server file.
 *
 * created by Meliksah Simsek Jan 21, 2019
 */
...
class TokenQrServer extends Server {
    ...
    private serveFrontEndProd(): void {
        const dir = path.join(__dirname, 'public/react/token-qr-react/');
